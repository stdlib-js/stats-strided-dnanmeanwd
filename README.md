...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@43d789bc0f899d8e613c03cad8477d6f783f3d90/lib/node_modules/@stdlib/stats/strided/dnanmeanwd/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div> -->
...
```javascript
dnanmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanmeanwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dnanmeanwd/tags). For example,

```javascript
dnanmeanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanmeanwd@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanmeanwd = require( 'path/to/vendor/umd/stats-strided-dnanmeanwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanmeanwd@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dnanmeanwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dnanmeanwd

[test-image]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dnanmeanwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dnanmeanwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dnanmeanwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dnanmeanwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dnanmeanwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dnanmeanwd/main/LICENSE
